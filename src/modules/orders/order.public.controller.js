...
const orderSelect = {
  id: true, status: true, totalMinor: true, currency: true, items: true, meta: true,
...
export const getMyOrders = asyncHandler(async (req, res) => {
  ...
  ok(res, orders.map(o => ({
    ...
    currency: o.currency,
    items: o.items,
    deliveryAddress: o.meta?.customerAddress || null,
    paymentMethod: o.meta?.paymentMethod || null,
    deliveryMethod: o.meta?.deliveryMethod || null,
